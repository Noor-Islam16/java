package com.Placements.Functions;
    ...
    public class MaxMinNumber {
        ...
        {   // creating scanner to accept radius of circle
            ...
            scanner.close();
        }   /** * Java method to calculate largest of three numbers * * @param first * @param second * @param third * @return maximum or largest of three */
        ...
        }   /** * Java method to calculate smallest of three numbers * * @param first * @param second * @param third * @return minimum or smallest of three */
